...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151511823.png)
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151512756.png)

# **▍**初始安装

建议安装后马上将笔记主题切换到**明亮模式**，或者尽快找到一款自己喜爱的第三方主题，**因为默认开启的黑暗模式简直是一场灾难**，可千万别被它的默认外观劝退了。在这里只能说 Bear 和 Notion 会受欢迎是有原因的，颜值还真就是生产力。
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151512324.png)
...
## 配置方法
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151512264.png)

## 日记模板

一般来说我更习惯于用无序列表来让记录这件事更纯粹一点，模板对我来说会有填空的压力。但你也可以事先设置诸如晨间日记、每日工作等模板。

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151512426.png)

设置好模板后，**使用快捷键**创建日记文档，就能自动调用这个模板，就像下图这样子：

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151513969.gif)
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151513428.gif)

**②** 打开这个文档的反向链接面板，它会在笔记库内搜索**这个关键词曾经出现过的位置**

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151513491.gif)

所以我们用 Daily Note 记录那些不成主题的碎片信息，直到你有明确的专项题目可以拓展，再通过反链面板去回溯过去在 Daily Note 中留下的碎片记录，有时候靠那不经意的一句吐槽都能带来无穷的启发。  

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151514514.png)
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151515589.png)

设置完毕后，你就可使用非常丰富的选项，来制定你的个性化任务面板，下面这段最简单的代码，能让你筛选出你**整个笔记库内所有未完成的任务。**

![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151518685.png)


![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151519957.png)  

你还可以参考开发者文档（https://schemar.github.io/obsidian-tasks/getting-started/），制定更加个性化的任务面板，也可简单参考我下图中的命令。  
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151519382.png)  
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151521462.png)
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151521345.png)
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151525706.png)
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151525584.png)

## Kanban 插件

你可以像 Trello、像 Teambition、或者像 Notion 中的 `Board 面板` 一样，去使用 Kanban 插件，它在常规看板的基础上，同样支持了双向链接功能，完整介绍你可以参考开发者这份文档。

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151525216.png)
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151526858.png)

**②** 每一张卡片都能创建为一份文档， 就像 Notion 中的 `/page 命令` ，你只需要点击 `从卡片新建笔记` 即可

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151526374.gif)
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151527421.png)
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151527526.png)

3. 如此一来，当我们在 `会议记录` 文件夹新建文档，它创建的就不是空白文档，而是加载了模板的文档了。
    

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151528617.gif)

你可能注意到了，上图调用模板生成文档时，还自动生成了时间 `2022-03-22`，原因是我在模板中使用了 Templater 提供的时间变量，用法类似 Excel 中的 =today()函数

![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151529653.png)


更多变量你可以参考阅读开发者的这份文档（https://silentvoid13.github.io/Templater/introduction.html），善用变量，你还可以在每天生成的日报中显示 上一页 和 下一页 的效果。

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151530215.gif)
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151530198.gif)

### 配置

1. 为 `创建日报` 添加一个 QuickAdd 动作

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151530401.png)

2. 先点击小闪电，这样才能在命令面板（Ctrl+P）中直接搜索到；再点击小齿轮， 进入详细配置界面

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151530884.png)
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151531162.png)
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151531418.gif)

你可以 Ctrl+ 鼠标左键点击 ，来打开同一份文档。左侧窗口使用 Ctrl+E 进入阅读视图，鼠标悬停在日报标题上方，通过弹出的小窗获取周报所需要的信息，然后就可以在右侧编辑视图下快速输入了。

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151531250.gif)

### Dataview 配置方法

将下面这段代码放到 Templater 模板库中，然后命名为 `周报模板`

![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151532934.png)


然后再设置当 `在周报文件夹创建文档` ，则 `调用周报模板`  

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151532876.png)

但是你会发现，上面那段代码会汇总 `工作` 文件夹中的**所有文件**，因为我们还没添加过滤条件

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151533080.gif)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151533399.png)


也可以用 Templater 插件在创建日报文档时自动插入

![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151534086.png)


好了现在我们可以让 Dataview 插件正确过滤**创建时间在 7 日之内**，并且**包含日报标签**的文档了。

![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151535158.png)


![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151535850.gif)

后面的内容我还讲反复提到这个插件，你可以自行阅读 Dataview 插件开发者文档，学习更多高端操作，也可以点击下面大图，参考 Dataview 的部分语法。

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151535034.png)
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151536016.gif)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151536712.png)


例如，如果我要打开存放在`附件`文件夹中的 `基督山伯爵.pdf`，则正确的语法应该是  

![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151537821.png)
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151537897.gif)

点击右上角的 Open as MD 将关闭批注模式，然后你就能看到，所有的高亮和批注都被搜集起来组成一篇文档了。

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151538940.gif)

Mindmap 插件

这个插件能够让文档的各级标题成为思维导图中的各个节点，并且导图中的各个节点也都是可以点击的。虽然导图的样式单一，且配色实在辣眼，但胜在简单易用。

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151538005.gif)

# **▍**用法 5、动态表格

这个用法本质上还是 Dataview 插件的另一种应用， 与前面的清单（list）不同，这次我们要绘制的是一张可以动态变化的表格（table）。假设我们为 4 本书分别写了 4 篇读后感，并在文档的最开头用 YAML 语法进行一点配置（打标签）

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151538437.png)

然后使用下面的 Dataview 语法进行配置

![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151539063.png)


翻译一下上面这段代码的意思  

![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151539577.png)


生成这样的表格效果如下图所示

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151539079.png)

这个表格会动态更新，实时扫描整个笔记库，只要你新增一篇在 YAML 表头包含了过滤标签的文档，它就会自动在表格内增加一行。

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151539138.gif)

# **▍**用法 6、视频笔记

作为一名新人 UP 主，我会特别注意视频中弹幕激增的节点，然后去分析这个 UP 主说了哪些话来激发观众发送弹幕的热情，很多看似 UP 主不经意的一句话，其实背后都能找到很多运营的门道。

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151540912.png)

B 站本身自带视频笔记功能，但只能说堪堪够用，回看笔记的入口很深，而且完全线上保存无法导出，好处是原生功能，打开即用无需折腾。

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151540684.gif)
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151540150.gif)

**案例：如何更有效地「骗」弹幕？**  

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151541726.png)
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151541006.png)
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151542466.png)

然后就像前面提到的阅读清单，这张表格也是可以实时动态更新的。

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151543679.gif)

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151543070.png)

## 使用 Charts 让数据可视化

这个插件能够让你手动插入如下图所示的五种图表

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151543605.gif)

安装完插件后，使用 Ctrl+P 唤出命令菜单，然后搜索 charts 关键词，选择 Insert new Chart 即可，然后剩下的就是手动输入数据的基本操作了。

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151543486.png)
...
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151544087.gif)

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151544573.png)

除了竖轴，还有横轴可以选择

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151544648.gif)

## Timelines 插件配置方法

乍一看，配置时间轴的代码非常简单，只需要像下面这样，筛选出所有包含影评标签的文章即可

![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151545159.png)


![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151546916.gif)

但这样做的前提是，我们需要在被筛选的文章内，先进行一点点配置。

首先必不可少的还是要先用 YAML 语言打上几个标签，其中 `timeline` 标签是必须的，另一个标签则可由你自定义。你可能注意到了，我们可以在 `[]` 内一次性输入多个标签。

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151546220.png)

然后还需要在正文中插入一段代码，来定义时间轴中的文章封面、标题、时间等。

![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151547454.png)


如果你直接复制上面的代码，**记得自行修改一下单引号内的内容**。其中我们需要修改的有 date 、title 、以及 img 这三项，否则时间轴的时间、标题和封面将无法正确显示。  

![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307151547821.png)
...
转载自：[Obsidian 8 个进阶用法 | 全网最细图文详解](https://mp.weixin.qq.com/s?__biz=MzI0ODIyNjU0OA==&mid=2247487978&idx=1&sn=8f2e8aa7357bf3659079e69c1902bbcb&chksm=e9a2a671ded52f6753f32c4d8c660873493aa86dcd60b525cb339cdc0c9e41899a05322d7841&mpshare=1&scene=23&srcid=07099ExSPXCDx9LrOZ8nyZji&sharer_sharetime=1688837683694&sharer_shareid=70c1a0c9f64da446b94cbbf562dda420#rd)

对应B站视频地址：https://www.bilibili.com/video/BV18a411r7mt/
...
创建表格的过程如下面的视频所示。
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307292325518.gif)

### 1.3、打开表格控制面板
高级表格插件提供了一个控制面板，方便用户操作，打开控制面板的快捷键为：`Ctrl` + `Shift` + `D`。 控制面板如下图所示。
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307292327156.png)
控制面板提供的功能包括：
...
### 1.4、快捷键
高级表格插件的快捷键如下表所示：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202307292332702.png)
