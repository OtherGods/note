来自：[沉默王二 破解合集](https://tobebetterjavaer.com/nice-article/itmind/shangwang.html)
...
## [#](https://tobebetterjavaer.com/nice-article/itmind/shangwang.html#下载安装-clash)下载安装 Clash

clash 是咳血上网的一个加速器，一个小软件，有 Windows、macOS、安卓、iOS（需要用Shadowrocket）等版本。

访问以下网址：

[https://repo.trojan-cdn.com/clash_for_windows_pkg/LatestRelease/open in new window](https://repo.trojan-cdn.com/clash_for_windows_pkg/LatestRelease/)
...
[https://api.efanapi.com/aff.php?aff=2849open in new window](https://api.efanapi.com/aff.php?aff=2849)
...
[https://balala.io/auth/register?code=gUrBopen in new window](https://balala.io/auth/register?code=gUrB)
...
[https://portal.shadowsocks.au/aff.php?aff=59537open in new window](https://portal.shadowsocks.au/aff.php?aff=59537)
