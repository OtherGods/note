[2、RocketMQ的事务消息是如何实现的？](2、相关技术/23、高并发高可用高性能/MQ/Hollis/RocketMQ/2、RocketMQ的事务消息是如何实现的？.md)

[15、Kafka支持事务消息吗？如何实现的？](2、相关技术/23、高并发高可用高性能/MQ/Hollis/Kafka/15、Kafka支持事务消息吗？如何实现的？.md)
