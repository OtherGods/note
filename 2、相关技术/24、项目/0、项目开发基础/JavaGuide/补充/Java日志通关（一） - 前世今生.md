...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408192148774.png)
...
为此Apache在2002年推出了一套接口Jakarta Commons Logging[15]，简称 JCL，它的主要作者仍然是Ceki。这套**接口**主动支持了Log4j、JUL、Apache Avalon、Lumberjack等众多日志工具。开发者如果想打印日志，只需调用JCL的接口即可，至于最终使用的日志实现则由最上层的业务系统决定。我们可以看到，这其实就是典型的接口与实现分离设计。

但因为是先有的实现（Log4j、JUL）后有的接口（JCL），所以JCL配套提供了接口与实现的适配层（没有使用它的最新版，原因会在【1.2.7 Log4j2 (2012)】提到）：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408192158366.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408192205667.png)

网上介绍Slf4j的文章，经常会引用它官网上的两张图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408192206821.png)

![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408192207008.png)
...
你会发现Log4j 2的设计别具一格，提供JCL和Slf4j之外的第三个**接口层**（log4j-api，虽然只是自己的接口），它在官网API Separation[33]一节中解释说，这样设计可以允许用户在一个项目中同时使用不同的接口层与实现层。
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408192227637.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408192228719.png)
...
转载自：[Java日志通关（一） - 前世今生](https://mp.weixin.qq.com/s/eIiu08fVk194E0BgGL5gow)
