...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202411102235628.png)

看一下这个玩意是咋回事儿：

这个switch 的内容是`connectionManager.getConnectionTransaction().getDistributedTransactionOperationType(autoCommit)` ，看一下`getDistributedTransactionOperationType`方法的实现：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202411102241541.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202411102243596.png)
...
也就是说，一旦全局事务开启了，**RootContext**的 XID 就已经有值了，那么也就意味着说，`isInTransaction` 方法将永远返回 true！！！！
...
https://github.com/apache/shardingsphere/issues/22356

https://github.com/apache/shardingsphere/issues/29681

我在尝试解决这个问题的时候，找到了相关内容，因为看到 issue 是 close 的，我以为解决了，因为ShardingJDBC官方自己说自己解决了。。。
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202411102247356.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202411102249734.png)
