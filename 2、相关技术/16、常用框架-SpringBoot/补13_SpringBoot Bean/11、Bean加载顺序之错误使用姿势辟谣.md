...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202402222125479.png)

### 2.1.2、err.case2: 配置类中Bean声明方法上添加@Order
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202402222127328.png)

从上面的实际测试输出可以看出，@Order注解在上面的方式中也不生效，如果有兴趣的同学可以试一下，将上面配置类中的两个方法的顺序颠倒一下，会发现`BaseDemo4`先加载

### 2.1.3、err.case3: @Order注解修饰配置类
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202402222128773.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202402222131520.png)
...
当注解生效时，BConf会优先级加载
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202402222132532.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202402222134082.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202402222146098.png)

根据上面的输出，也可以看出列表中的顺序和我们预期的一致，并且 `AnoOrderBean1`与 `AnoOrderBean2` 的加载顺序和注解没有关系

## 3.2、@AutoConfigureOrder
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202402222208267.png)
