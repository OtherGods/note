...
```sql
INSERT INTO `user` (id, third_account_id, `user_name`, `password`, login_type, deleted)  <br>VALUES (1, 'a7cb7228-0f85-4dd5-845c-7c5df3746e92', 'admin', 'admin', 0, 0);
```
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202310302130140.png)
...
- 实例源码: [https://github.com/liuyueyi/spring-boot-demo/tree/master/spring-boot/](https://github.com/liuyueyi/spring-boot-demo/tree/master/spring-boot/)
