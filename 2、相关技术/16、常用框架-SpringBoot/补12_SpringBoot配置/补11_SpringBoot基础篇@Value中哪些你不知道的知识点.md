...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202402182252388.png)

所以为了避免上面的问题，一般来讲，建议设置一个默认值，规则如 `${key:默认值}`， 在第一个冒号右边的就是默认值，当没有相关配置时，使用默认值初始化
```java
/**  
 * 不存在，使用默认值  
 */  
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202402202128566.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202402202130804.png)
...
/**  
 * @author yihui * @date 2021/6/2 */@Primary  
@Component  
public class MyPropertySourcesPlaceHolderConfigure extends PropertySourcesPlaceholderConfigurer {  
     ...
     * will be searched when replacing ${...} placeholders.     *     * @see #setPropertySources     * @see #postProcessBeanFactory     */    @Override  
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202402202221850.png)
...
再次测试，同样可以注入成功
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202402202234564.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202402202235200.png)
