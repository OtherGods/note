...
我们创建一个新的SpringBoot项目之后，不加任何配置，引入几个Starter就可以跑起来，一个常见的疑问就是当引入`spring-boot-starter-web`来启动web服务时，默认开启的端口号是什么？怎么改？

## 1.1、默认的配置文件

下面贴出的配置，来源于: [Appendix A. Common application properties](https://docs.spring.io/spring-boot/docs/current/reference/html/common-application-properties.html)
```properties
# ===================================================================  
...
- 实例源码: [https://github.com/liuyueyi/spring-boot-demo/tree/master/spring-boot/002-properties](https://github.com/liuyueyi/spring-boot-demo/tree/master/spring-boot/002-properties)
