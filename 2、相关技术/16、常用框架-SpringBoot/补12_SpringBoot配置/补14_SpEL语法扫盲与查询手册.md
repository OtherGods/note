...
如果想获取Class对象，或者访问静态成员/方法，可以借助`T()`语法来实现；访问实例方法可以直接调用，参考 [1.10、bean访问](补14_SpEL语法扫盲与查询手册#1.10、bean访问)。
...
- 其次访问bean的前缀修饰为`@`符号
	- 不加 `@` 也可以访问容器中的Bean，前提是 默认引用当前上下文中已存在的Bean。
...
- 实例源码: 
	- [https://github.com/liuyueyi/spring-boot-demo/spring-boot/013-spel](https://github.com/liuyueyi/spring-boot-demo/spring-boot/013-spel)
...
转载自：[【基础系列】SpEL语法扫盲与查询手册](https://spring.hhui.top/spring-blog/2020/05/18/200518-SpringBoot%E7%B3%BB%E5%88%97%E4%B9%8BSpEL%E8%AF%AD%E6%B3%95%E6%89%AB%E7%9B%B2%E4%B8%8E%E6%9F%A5%E8%AF%A2%E6%89%8B%E5%86%8C/)