...
===！！！注意：这里说的是SpringBoot中静态资源的四个默认路径及优先级，要与SpringBoot中配置文件的四个默认路径及优先级做区分===

静态资源路径，SpringBoot默认从属性`spring.resources.static-locations`中获取，默认值可以从`org.springframework.boot.autoconfigure.web.ResourceProperties#CLASSPATH_RESOURCE_LOCATIONS`获取
```java
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202309101041287.png)


### 1.2.1、META-INF/resources
...
```
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202309101043806.png)
...
```
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202309101045770.png)
...
```
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202309101046860.png)
...
```
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202309101048885.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202309101051253.png)
...
```
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202309101052668.png)


## 2.2、WebMvcConfigurer添加资源映射
...
```
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202309101056766.png)

# 3、Jar包资源访问

前面描述的静态资源访问主要都是当前包内的资源访问，如果我们的静态资源是由第三方的jar包提供（比如大名鼎鼎的Swagger UI)，这种时候使用姿势是否有不一样的呢？

## 3.1、classpath 与 classpath*
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202309101100346.png)

接着在我们上面创建的 204-web-static-resources 工程中，添加依赖
```properties
<dependency>  
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202309101107226.png)
...
- 实例源码: 
  [https://github.com/OtherGods/paicoding-yihui-spring-boot-demo/tree/master/spring-boot/204-web-static-resources](https://github.com/OtherGods/paicoding-yihui-spring-boot-demo/tree/master/spring-boot/204-web-static-resources)
  [https://github.com/OtherGods/paicoding-yihui-spring-boot-demo/tree/master/spring-boot/204-web-static-resources-ui](https://github.com/OtherGods/paicoding-yihui-spring-boot-demo/tree/master/spring-boot/204-web-static-resources-ui)
...
转载自：[【WEB系列】静态资源配置与读取](https://spring.hhui.top/spring-blog/2020/06/11/200611-SpringBoot%E7%B3%BB%E5%88%97%E6%95%99%E7%A8%8BWeb%E7%AF%87%E4%B9%8B%E9%9D%99%E6%80%81%E8%B5%84%E6%BA%90%E9%85%8D%E7%BD%AE/)