...
实际请求之后，看一下效果：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202309101501368.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202309101516151.png)

## 2.2、返回结果

对于返回结果，希望返回下划线格式的json串，除了上面介绍到的设置json序列化的命名策略之外，还有下面几种配置方式

### 2.2.1、属性注解@JsonProperty
...
本文主要介绍了几种实例case，用于实现传参/返回的驼峰下划线的互转，核心策略，有以下几种：
1. 传参：`@RequestParam` 指定真正的传参name
2. Json传参、返回：通过定义json序列化框架的PropertyNamingStrategy，来实现
3. 普通表单传参/get传参数，映射POJO时：通过自定义的DataBinder，来实现映射
...
- 实例源码: [https://github.com/liuyueyi/spring-boot-demo/tree/master/spring-boot/202-web-params-camel](https://github.com/liuyueyi/spring-boot-demo/tree/master/spring-boot/202-web-params-camel)
...
转载自：[【WEB系列】如何支持下划线驼峰互转的传参与返回](https://spring.hhui.top/spring-blog/2022/01/17/220117-SpringBoot%E7%B3%BB%E5%88%97%E4%B9%8BWeb%E5%A6%82%E4%BD%95%E6%94%AF%E6%8C%81%E4%B8%8B%E5%88%92%E7%BA%BF%E9%A9%BC%E5%B3%B0%E4%BA%92%E8%BD%AC%E7%9A%84%E4%BC%A0%E5%8F%82%E4%B8%8E%E8%BF%94%E5%9B%9E/)