...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202309042317242.png)
...
**说明：使用`@RequestBody`注解之后，可解析提交的json串；但不再支持表单提交参数方式(`application/x-www-form-urlencoded`)【POST请求中若不指定请求头中ContentType，则默认是表单格式】**
...
需要注意的是，对于传统的表单提交(application/x-www-form-urlencoded)方式，get的参数解析依然可以使用
- @RequsetParam
- POJO（BEAN的解析方式）
- @PathVariable参数解析
- 方法参数解析
...
- 实例源码: [https://github.com/liuyueyi/spring-boot-demo/blob/master/spring-boot/202-web-params](https://github.com/liuyueyi/spring-boot-demo/blob/master/spring-boot/202-web-params)
...
转载自：[【WEB系列】Post请求参数解析姿势汇总](https://spring.hhui.top/spring-blog/2019/08/28/190828-SpringBoot%E7%B3%BB%E5%88%97%E6%95%99%E7%A8%8Bweb%E7%AF%87%E4%B9%8BPost%E8%AF%B7%E6%B1%82%E5%8F%82%E6%95%B0%E8%A7%A3%E6%9E%90%E5%A7%BF%E5%8A%BF%E6%B1%87%E6%80%BB/)