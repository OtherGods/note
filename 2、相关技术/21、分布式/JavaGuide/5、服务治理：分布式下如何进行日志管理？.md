...
[日志记录方案有哪些？](2、相关技术/24、项目/0、项目开发基础/JavaGuide/日志记录方案有哪些？.md)
...
![1.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408172138278.png)
...
![1.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408172140713.png)
...
- **Kibana** ：Kibana 是专门设计用来与 Elasticsearch 协作的，可以自定义多种表格、柱状图、饼状图、折线图对存储在 Elasticsearch 中的数据进行深入挖掘分析与可视化。 ELK 日志系统中，Kibana 主要负责对从 Elasticsearch 中搜索出来的日志进行可视化展示。
...
![1.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408172146270.png)
...
![1.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408172149431.png)

现在的 ELK 架构变成了这样：
![1.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408172150971.png)
...
根据[Filebeat 官方](https://www.elastic.co/cn/beats/filebeat)介绍：
...
Filebeat 能够轻松地将数据传送到 Logstash（对日志进行处理）、Elasticsearch（日志检索）、甚至是 Kibana （日志展示）中。![1.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408172205510.png)
...
## 3.3、Filebeat+Logstash+Elasticsearch+Kibana 架构概览
...
![1.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408172208239.png)
...
![1.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408172210950.png)
...
官方的介绍也比较有意思哈！ Like Prometheus,But For Logs. （类似于 Prometheus 的日志系统，不过主要是为日志服务的）。![1.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408172215914.png)

根据官网 ，Loki 的架构如下图所示
![1.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408172218941.png)
...
另外，推荐看看这篇文章：[B 站基于 Clickhouse 的下一代日志体系建设实践 - 哔哩哔哩技术 - 2022](https://www.yuque.com/r/goto?url=https%3A%2F%2Fmp.weixin.qq.com%2Fs%2FdUs7WUKUDOf9lLG6tzdk0g)（B 站初期架构也是 ELK ，后来新架构使用 ClickHouse 作为存储，自研日志可视化查询分析平台，这篇文章的后续：持续降本：[B 站日志平台 3.0 演进之路 - 哔哩哔哩技术 - 2023](https://mp.weixin.qq.com/s/tnP6hI2KwPde7PGg6QyUCw)。
...
2. ELK 架构和 Filebeat 工作原理详解：[https://elastic-stack.readthedocs.io/en/latest/introduction.html](https://elastic-stack.readthedocs.io/en/latest/introduction.html)
