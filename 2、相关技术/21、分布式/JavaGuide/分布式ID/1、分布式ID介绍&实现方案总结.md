...
这个时候就需要生成**分布式 ID**了。
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408012142326.png)

## 1.3、分布式ID需要满足那些要求？

![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408012142555.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408012148350.png)
...
数据库的号段模式也是目前比较主流的一种分布式 ID 生成方式。像滴滴开源的[Tinyidopen](https://github.com/didi/tinyid/wiki/tinyid%E5%8E%9F%E7%90%86%E4%BB%8B%E7%BB%8D) 就是基于这种方式来做的。不过，TinyId 使用了双号段缓存、增加多 db 支持等方式来进一步优化。
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408012204243.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408012214679.png)
...
关于 Redis 持久化，我这里就不过多介绍。不了解这部分内容的小伙伴，可以看看 [Redis持久化机制详解](2、相关技术/5、数据库-Redis/JavaGuide/重要知识点/Redis持久化机制详解.md) 这篇文章。
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408012226611.png)
...
![1.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408012230573.png)
...
![1.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408012234294.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408012237669.png)
...
- [Seata 基于改良版雪花算法的分布式 UUID 生成器分析open in new window](https://seata.io/zh-cn/blog/seata-analysis-UUID-generator.html)
- [在开源项目中看到一个改良版的雪花算法，现在它是你的了。open in new window](https://www.cnblogs.com/thisiswhy/p/17611163.html)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408012242517.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408012244852.png)

自 18 年后，UidGenerator 就基本没有再维护了，我这里也不过多介绍。想要进一步了解的朋友，可以看看 [UidGenerator 的官方介绍open in new window](https://github.com/baidu/uid-generator/blob/master/README.zh_cn.md)。
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408012245177.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408012246625.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408012247461.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408012248809.png)
...
不过，本文主要介绍的是分布式 ID 的理论知识。在实际的面试中，面试官可能会结合具体的业务场景来考察你对分布式 ID 的设计，你可以参考这篇文章：[2、分布式ID设计指南](2、相关技术/21、分布式/JavaGuide/分布式ID/2、分布式ID设计指南.md) （对于实际工作中分布式 ID 的设计也非常有帮助）。


转载自：[分布式ID介绍&实现方案总结](https://javaguide.cn/distributed-system/distributed-id.html)
