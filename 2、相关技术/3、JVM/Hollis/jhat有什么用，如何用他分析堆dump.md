...
`jhat`(Java Heap Analysis Tool),是一个用来 **==分析java的堆情况==** 的命令。使用jmap生成的Java堆的Dump文件可以用jhat命令将其转成html的形式，然后通过http访问可以查看堆情况。

`jhat`命令解析会Java堆dump并启动一个web服务器，然后就可以在浏览器中查看堆的dump文件了。
...
页面如下：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202508011823330.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202508011832083.png)

`Show heap histogram` 以树状图形式展示堆情况。如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202508011838338.png)
