#创建线程 #可以参考Thread的构造参数，分为两种：需要传递Runnable和不需要传递Runnable 
...
- Callable中可以够抛出受检异常(checked exception),而Runnable不可以。
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202509280016430.png)
...
[8、什么是线程池，如何实现的？](2、相关技术/2、JUC/Hollis/Java并发/8、什么是线程池，如何实现的？.md)
