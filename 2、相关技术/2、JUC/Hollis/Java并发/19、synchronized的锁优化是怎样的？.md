...
https://www.yuque.com/hollis666/io9xi1/cv5kt1
https://www.yuque.com/hollis666/io9xi1/dc6vfx4nfvptib2y
...
这种互斥锁在互斥同步上对性能的影响很大，<font color="red">Java的线程是映射到操作系统原生线程（内核线程）之上的，如果<font color="blue">要阻塞或唤醒一个线程就需要操作系统的帮忙，这就要从用户态转换到内核态</font>，因此状态转换需要花费很多的处理器时间</font>。
...
![1.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507052357284.png)
...
![1.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507060000469.png)

能这么做的前提是，没有人和你抢着办业务。

上面的这种例子，在锁优化中被称作“锁消除”，是**JIT编译器对内部锁的具体实现所做的一种优化**。
...
![1.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507060005632.png)
