...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507062018211.png)
...
### 2.0.1 thenRunAsync：不能接收上一次的执行结果，也没返回值
```java
        /**
...
### 2.0.2 thenAcceptAsync：能接收上一次的执行结果，但没返回值
```java
    /**
...
### 2.0.3 thenApplyAsync：能接收上一次的执行结果，又可以有返回值
```java
        /**
...
### 3.0.2 三任务组合，前两个任务只要有一个完成，就执行任务3
...
转载自：[https://juejin.cn/post/7140244126679138312](https://juejin.cn/post/7140244126679138312)
