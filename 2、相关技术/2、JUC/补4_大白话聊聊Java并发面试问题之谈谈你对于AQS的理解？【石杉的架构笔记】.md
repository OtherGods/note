...
上一篇文章聊了一下java并发中常用的原子类的原理和Java 8的优化，具体请参见文章：[大白话聊聊Java并发面试问题之Java 8如何优化CAS性能？](https://juejin.cn/post/6844903731234865160)。
...
![image-20221021090358148](D:\Tyora\AssociatedPicturesInTheArticles\大白话聊聊Java并发面试问题之谈谈你对于AQS的理解？【石杉的架构笔记】\image-20221021090358148.png)
...
![image-20221021090415472](D:\Tyora\AssociatedPicturesInTheArticles\大白话聊聊Java并发面试问题之谈谈你对于AQS的理解？【石杉的架构笔记】\image-20221021090415472.png)
...
![image-20221021090427393](D:\Tyora\AssociatedPicturesInTheArticles\大白话聊聊Java并发面试问题之谈谈你对于AQS的理解？【石杉的架构笔记】\image-20221021090427393.png)

接着线程1跑过来调用ReentrantLock的lock()方法尝试进行加锁，这个加锁的过程，直接就是用CAS操作将state值从0变为1。

如果不知道CAS是啥的，请看上篇文章，[大白话聊聊Java并发面试问题之Java 8如何优化CAS性能？](https://juejin.cn/post/6844903731234865160)

如果之前没人加过锁，那么state的值肯定是0，此时线程1就可以加锁成功。

一旦线程1加锁成功了之后，就可以设置当前加锁线程是自己。所以大家看下面的图，就是线程1跑过来加锁的一个过程。

![image-20221021090440348](D:\Tyora\AssociatedPicturesInTheArticles\大白话聊聊Java并发面试问题之谈谈你对于AQS的理解？【石杉的架构笔记】\image-20221021090440348.png)
...
![image-20221021090502963](D:\Tyora\AssociatedPicturesInTheArticles\大白话聊聊Java并发面试问题之谈谈你对于AQS的理解？【石杉的架构笔记】\image-20221021090502963.png)
...
![image-20221021090516428](D:\Tyora\AssociatedPicturesInTheArticles\大白话聊聊Java并发面试问题之谈谈你对于AQS的理解？【石杉的架构笔记】\image-20221021090516428.png)

接着，线程1在执行完自己的业务逻辑代码之后，就会释放锁！**他释放锁的过程非常的简单**，就是将AQS内的state变量的值递减1，如果state值为0，则彻底释放锁，会将“加锁线程”变量也设置为null！

整个过程，参见下图：

![image-20221021090533134](D:\Tyora\AssociatedPicturesInTheArticles\大白话聊聊Java并发面试问题之谈谈你对于AQS的理解？【石杉的架构笔记】\image-20221021090533134.png)
...
![image-20221021090550080](D:\Tyora\AssociatedPicturesInTheArticles\大白话聊聊Java并发面试问题之谈谈你对于AQS的理解？【石杉的架构笔记】\image-20221021090550080.png)
...
作者：石杉的架构笔记
链接：https://juejin.cn/post/6844903732061159437
来源：稀土掘金
