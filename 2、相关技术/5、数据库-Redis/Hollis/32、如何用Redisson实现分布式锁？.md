...
- [9、分布式锁组件：nft-turbo-lock](2、相关技术/24、项目/3、数藏项目/9、公共组件/9、分布式锁组件：nft-turbo-lock.md)

在使用SETNX实现的分布式锁中，因为存在锁无法续期导致并发冲突的问题，所以在真实的生产环境中用的并不是很多，其实，真正在使用Redis时，用的比较多的是基于Redisson实现分布式锁。

> Redisson是一个基于Redis的Java客户端，它提供了丰富的功能，包括分布式锁的支持。 https://redisson.org/
> 
...
[28、公平锁和非公平锁的区别？](2、相关技术/2、JUC/Hollis/Java并发/28、公平锁和非公平锁的区别？.md)
