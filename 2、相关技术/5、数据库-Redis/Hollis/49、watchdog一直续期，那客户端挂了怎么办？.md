...
上一篇文章中介绍了关于看门狗的机制，他<font color="red">会在用户没有指定锁的超时时间的时候，给锁做续期，他会有一个后台线程，定时的给锁续期</font>。
...
因为我们知道，<font color="red">锁的续期是Redisson实现的，而Redisson的后台任务是基于JVM运行的，也就是说，如果这台机器挂了，<font color="blue">那么Redisson的后台任务也就没办法继续执行了</font>。</font>
