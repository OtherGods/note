#Redisson即使解锁失败watchdog也会取消续期 

# 典型回答

不会的，因为<font color="red">在解锁过程中，不管是解锁失败了，还是解锁时抛了异常，都还是会把本地的续期任务停止，避免下次续期</font>。
...
那么通过 [35、Redisson的watch dog机制是怎么样的](2、相关技术/5、数据库-Redis/Hollis/35、Redisson的watch%20dog机制是怎么样的.md) 我们知道，续期是需要依赖EXPIRATION_RENEWAL_MAP的，如果某个线程不在EXPIRATION_RENEWAL_MAP里面了，就不会再被续期了。
