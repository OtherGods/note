#redis中ziplist的级联更新问题 #ziplist中每个元素中都有一个字段记录前一个元素的大小，这个字段长度不固定 

# 典型回答

ZipList是Redis中的一个数据结构，用来实现ZSet，他是一个压缩的数据结构，它的每个元素都是连续存储的，因此内存的使用非常紧凑。
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507131002647.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507131005845.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507131007355.png)
