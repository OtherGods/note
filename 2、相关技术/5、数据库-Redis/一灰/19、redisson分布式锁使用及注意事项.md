...
/**  
 * @author yihui * @date 2021/3/1 */@Service  
public class IllegalLockSample {  
    @Autowired  
    private RedissonClient redissonClient;  
      
    // scheduledExecutorService 是一个单线程的调度线程池，用于定期执行任务。  
    ...
    //@PostConstruct注解表明此方法会在依赖注入完成后自动调用。
    @PostConstruct  
    public void init() {  
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202405261556345.png)

两个线程池

- 一个固定大小的线程池（2个线程，线程不会被回收）：再次访问时，之前持有锁的线程依然可以获取锁；另外一个不行
...
- 实例源码: [https://github.com/liuyueyi/spring-boot-demo/tree/master/spring-boot/126-redisson](https://github.com/liuyueyi/spring-boot-demo/tree/master/spring-boot/126-redisson
...
转载自：[【DB系列】redisson分布式锁使用及注意事项](https://spring.hhui.top/spring-blog/2021/03/01/210301-SpringBoot%E7%B3%BB%E5%88%97redisson%E5%88%86%E5%B8%83%E5%BC%8F%E9%94%81%E4%BD%BF%E7%94%A8%E5%8F%8A%E6%B3%A8%E6%84%8F%E4%BA%8B%E9%A1%B9/)
