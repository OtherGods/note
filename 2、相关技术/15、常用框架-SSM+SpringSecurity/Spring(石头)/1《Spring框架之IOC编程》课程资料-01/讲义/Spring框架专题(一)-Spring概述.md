![20201229124636151.png (1123×476)](D:\Tyora\AssociatedPicturesInTheArticles\Spring框架专题(一)-Spring概述\20201229124636151.png)

[TOC]

# 1.Spring框架是什么

![20201228155222760.png (879×282)](D:\Tyora\AssociatedPicturesInTheArticles\Spring框架专题(一)-Spring概述\20201228155222760.png)
...
![20201228160612850.png (1919×969)](D:\Tyora\AssociatedPicturesInTheArticles\Spring框架专题(一)-Spring概述\20201228160612850.png)
...
Spring体系结构如下图：
![20201228161013264.png (811×534)](D:\Tyora\AssociatedPicturesInTheArticles\Spring框架专题(一)-Spring概述\20201228161013264.png)

## 3.1.核心容器

![image-20220807095228098](D:\Tyora\AssociatedPicturesInTheArticles\Spring框架专题(一)-Spring概述\image-20220807095228098.png)
...
- **Spring-context模块**：建立在Core和Beans模块的基础之上，提供一个框架式的bean对象访问方式，是访问定义和配置的任何对象的媒介。ApplicationContext接口是Context模块的焦点。
...
![image-20220807095241900](D:\Tyora\AssociatedPicturesInTheArticles\Spring框架专题(一)-Spring概述\image-20220807095241900.png)
...
![image-20220807095302801](D:\Tyora\AssociatedPicturesInTheArticles\Spring框架专题(一)-Spring概述\image-20220807095302801.png)

Spring4.0以后新增了消息（Spring-messaging）模块，该模块提供了对消息传递体系结构和协议的支持。

## 3.4.数据访问/集成

![image-20220807095331139](D:\Tyora\AssociatedPicturesInTheArticles\Spring框架专题(一)-Spring概述\image-20220807095331139.png)
...
## 3.5.Web（也就是Spring MVC框架）

![image-20220807095348749](D:\Tyora\AssociatedPicturesInTheArticles\Spring框架专题(一)-Spring概述\image-20220807095348749.png)
...
- **Spring-webmvc模块**：也称为Servlet模块，包含用于web应用程序的Spring MVC和REST Web Services实现。Spring MVC框架提供了领域模型代码和Web表单之间的清晰分离，并与Spring Framework的所有其他功能集成。
- **Spring-websocket模块**：Spring4.0以后新增的模块，它提供了WebSocket和SocketJS的实现。
- **WebFlux模块**：也称为类Portlet，似于Servlet模块的功能，提供了Portlet环境下的MVC实现。

## 3.6.测试

![image-20220807095408020](D:\Tyora\AssociatedPicturesInTheArticles\Spring框架专题(一)-Spring概述\image-20220807095408020.png)
...
![20201228162149486.png (1869×996)](D:\Tyora\AssociatedPicturesInTheArticles\Spring框架专题(一)-Spring概述\20201228162149486.png)

## 4.2.下载地址
[https://repo.spring.io/release/org/springframework/spring/](https://repo.spring.io/release/org/springframework/spring/)
![20201228162433977.png (1430×748)](D:\Tyora\AssociatedPicturesInTheArticles\Spring框架专题(一)-Spring概述\20201228162433977.png)
