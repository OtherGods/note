来自掘金：[比较Spring AOP与AspectJ](https://juejin.cn/post/6844903555531276296)
...
更多关于AspectJ的信息，请见[head on over to this article](https://link.juejin.cn?target=http%3A%2F%2Fwww.baeldung.com%2Faspectj)。

AspectJ使用的是编译期和类加载时进行织入，Spring AOP利用的是运行时织入。

运行时织入，在使用目标对象的代理执行应用程序时，编译这些切面（使用JDK动态代理或者CGLIB代理）。

![image-20221005194752006](D:\Tyora\AssociatedPicturesInTheArticles\补2-比较Spring AOP与AspectJ\image-20221005194752006.png)
...
![image-20221005194818319](D:\Tyora\AssociatedPicturesInTheArticles\补2-比较Spring AOP与AspectJ\image-20221005194818319.png)
...
由于以上原因，AspectJ经过测试大概8到35倍快于Spring AOP。[benchmarks](https://link.juejin.cn?target=https%3A%2F%2Fweb.archive.org%2Fweb%2F20150520175004%2Fhttps%3A%2F%2Fdocs.codehaus.org%2Fdisplay%2FAW%2FAOP%2BBenchmark)

## 对比

这个快速表总结了Spring AOP和AspectJ之间的主要区别：

![image-20221005194837163](D:\Tyora\AssociatedPicturesInTheArticles\补2-比较Spring AOP与AspectJ\image-20221005194837163.png)对比
...
作者：aoho
链接：https://juejin.cn/post/6844903555531276296
来源：稀土掘金
