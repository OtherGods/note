...
![img](D:\Tyora\AssociatedPicturesInTheArticles\补1-Spring Bean的生命周期（非常详细）\181453414212066.png)
![img](D:\Tyora\AssociatedPicturesInTheArticles\补1-Spring Bean的生命周期（非常详细）\181454040628981.png)
...
首先是一个简单的Spring Bean调用Bean自身的方法和Bean级生命周期接口方法，为了方便演示，它实现了BeanNameAware、BeanFactoryAware、InitializingBean和DiposableBean这4个接口，同时有2个方法，对应配置文件中<bean>的init-method和destroy-method。如下：
