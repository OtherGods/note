...
1. **Interceptor**：拦截器接口，定义了**Mybatis插件的基本功能，包括插件的初始化、插件的拦截方法以及插件的销毁方法**。
2. **Invocation**：调用接口，表示**Mybatis在执行SQL语句时的状态，包括SQL语句、参数、返回值等信息**。
...
[14、PageHelper分页的原理是什么？](2、相关技术/15、常用框架-SSM+SpringSecurity/Hollis/Mybatis/14、PageHelper分页的原理是什么？.md)
