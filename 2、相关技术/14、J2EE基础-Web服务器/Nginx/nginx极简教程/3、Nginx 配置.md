...
### [监听 80 和 443 端口](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e7%9b%91%e5%90%ac-80-%e5%92%8c-443-%e7%ab%af%e5%8f%a3)
...
### [防止使用未定义的服务器名称处理请求](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e9%98%b2%e6%ad%a2%e4%bd%bf%e7%94%a8%e6%9c%aa%e5%ae%9a%e4%b9%89%e7%9a%84%e6%9c%8d%e5%8a%a1%e5%99%a8%e5%90%8d%e7%a7%b0%e5%a4%84%e7%90%86%e8%af%b7%e6%b1%82)
...
### [指令中只配置一个 SSL](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e6%8c%87%e4%bb%a4%e4%b8%ad%e5%8f%aa%e9%85%8d%e7%bd%ae%e4%b8%80%e4%b8%aa-ssl)
...
## [性能](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e6%80%a7%e8%83%bd)
...
### [避免使用 `if` 检查 `server_name`](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e9%81%bf%e5%85%8d%e4%bd%bf%e7%94%a8-if-%e6%a3%80%e6%9f%a5-server_name)
...
### [使用 `$request_uri` 来避免使用正则表达式](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e4%bd%bf%e7%94%a8-request_uri-%e6%9d%a5%e9%81%bf%e5%85%8d%e4%bd%bf%e7%94%a8%e6%ad%a3%e5%88%99%e8%a1%a8%e8%be%be%e5%bc%8f)
...
### [开启 PCRE JIT 来加速正则表达式处理](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e5%bc%80%e5%90%af-pcre-jit-%e6%9d%a5%e5%8a%a0%e9%80%9f%e6%ad%a3%e5%88%99%e8%a1%a8%e8%be%be%e5%bc%8f%e5%a4%84%e7%90%86)
...
#### [使用 `limit_conn` 改善对下载速度的限制](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e4%bd%bf%e7%94%a8-limit_conn-%e6%94%b9%e5%96%84%e5%af%b9%e4%b8%8b%e8%bd%bd%e9%80%9f%e5%ba%a6%e7%9a%84%e9%99%90%e5%88%b6)
...
- **[⬆ Hardening](https://github.com/trimstray/nginx-admins-handbook#toc-hardening-2)**
    ...
    - [Prevent Replay Attacks on Zero Round-Trip Time](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-prevent-replay-attacks-on-zero-round-trip-time)
...
###  [![beginner](https://github.githubassets.com/images/icons/emoji/unicode/1f530.png?v8.png) Run as an unprivileged user](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-run-as-an-unprivileged-user)
...
#### [Rationale](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=rationale-7)
...
#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-7)
...
###  [![beginner](https://github.githubassets.com/images/icons/emoji/unicode/1f530.png?v8.png) Keep only TLS 1.3 and TLS 1.2](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-keep-only-tls-13-and-tls-12)
...
###  [![beginner](https://github.githubassets.com/images/icons/emoji/unicode/1f530.png?v8.png) Use only strong ciphers](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-use-only-strong-ciphers)
...
###  [![beginner](https://github.githubassets.com/images/icons/emoji/unicode/1f530.png?v8.png) Use more secure ECDH Curve](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-use-more-secure-ecdh-curve)
...
> Use only [TLSv1.3 and TLSv1.2](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=keep-only-tls1.2-tls13) and [only strong ciphers](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=use-only-strong-ciphers) with above curves:
...
> If you use `ECDH/ECDHE` key exchange please see [Use more secure ECDH Curve](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-use-more-secure-ecdh-curve) rule.
...
#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-11)
...
#### [External resources](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=external-resources-13)
...
###  [![beginner](https://github.githubassets.com/images/icons/emoji/unicode/1f530.png?v8.png) Prevent Replay Attacks on Zero Round-Trip Time](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-prevent-replay-attacks-on-zero-round-trip-time)

#### [Rationale](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=rationale-14)
...
#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-12)
...
#### [External resources](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=external-resources-14)
...
###  [![beginner](https://github.githubassets.com/images/icons/emoji/unicode/1f530.png?v8.png) Defend against the BEAST attack](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-defend-against-the-beast-attack)

#### [Rationale](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=rationale-15)
...
#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-13)

```
ssl_prefer_server_ciphers on;
```

#### [External resources](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=external-resources-15)
...
- [Use only strong ciphers (from this handbook)](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-use-only-strong-ciphers)

###  [![beginner](https://github.githubassets.com/images/icons/emoji/unicode/1f530.png?v8.png) Mitigation of CRIME/BREACH attacks](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-mitigation-of-crimebreach-attacks)

#### [Rationale](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=rationale-16)
...
#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-14)
...
#### [External resources](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=external-resources-16)
...
###  [![beginner](https://github.githubassets.com/images/icons/emoji/unicode/1f530.png?v8.png) HTTP Strict Transport Security](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-http-strict-transport-security)

#### [Rationale](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=rationale-17)
...
#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-15)

```
add_header Strict-Transport-Security "max-age=63072000; includeSubdomains" always;
```

  ![arrow_right](https://github.githubassets.com/images/icons/emoji/unicode/27a1.png?v8.png) ssllabs score: **A+**

#### [External resources](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=external-resources-17)
...
###  [![beginner](https://github.githubassets.com/images/icons/emoji/unicode/1f530.png?v8.png) Reduce XSS risks (Content-Security-Policy)](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-reduce-xss-risks-content-security-policy)

#### [Rationale](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=rationale-18)
...
#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-16)
...
#### [External resources](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=external-resources-18)
...
###  [![beginner](https://github.githubassets.com/images/icons/emoji/unicode/1f530.png?v8.png) Control the behaviour of the Referer header (Referrer-Policy)](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-control-the-behaviour-of-the-referer-header-referrer-policy)

#### [Rationale](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=rationale-19)

> Determine what information is sent along with the requests.

#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-17)

```
add_header Referrer-Policy "no-referrer";
```

#### [External resources](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=external-resources-19)
...
###  [![beginner](https://github.githubassets.com/images/icons/emoji/unicode/1f530.png?v8.png) Provide clickjacking protection (X-Frame-Options)](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-provide-clickjacking-protection-x-frame-options)

#### [Rationale](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=rationale-20)
...
#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-18)

```
add_header X-Frame-Options "SAMEORIGIN" always;
```

#### [External resources](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=external-resources-20)
...
###  [![beginner](https://github.githubassets.com/images/icons/emoji/unicode/1f530.png?v8.png) Prevent some categories of XSS attacks (X-XSS-Protection)](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-prevent-some-categories-of-xss-attacks-x-xss-protection)

#### [Rationale](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=rationale-21)

> Enable the cross-site scripting (XSS) filter built into modern web browsers.

#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-19)

```
add_header X-XSS-Protection "1; mode=block" always;
```

#### [External resources](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=external-resources-21)
...
###  [![beginner](https://github.githubassets.com/images/icons/emoji/unicode/1f530.png?v8.png) Prevent Sniff Mimetype middleware (X-Content-Type-Options)](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-prevent-sniff-mimetype-middleware-x-content-type-options)

#### [Rationale](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=rationale-22)

> It prevents the browser from doing MIME-type sniffing (prevents "mime" based attacks).

#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-20)

```
add_header X-Content-Type-Options "nosniff" always;
```

#### [External resources](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=external-resources-22)
...
###  [![beginner](https://github.githubassets.com/images/icons/emoji/unicode/1f530.png?v8.png) Deny the use of browser features (Feature-Policy)](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-deny-the-use-of-browser-features-feature-policy)

#### [Rationale](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=rationale-23)
...
#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-21)
...
#### [External resources](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=external-resources-23)
...
###  [![beginner](https://github.githubassets.com/images/icons/emoji/unicode/1f530.png?v8.png) Reject unsafe HTTP methods](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-reject-unsafe-http-methods)

#### [Rationale](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=rationale-24)
...
#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-22)
...
#### [External resources](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=external-resources-24)

- [Vulnerability name: Unsafe HTTP methods](https://www.onwebsecurity.com/security/unsafe-http-methods.html)

###  [![beginner](https://github.githubassets.com/images/icons/emoji/unicode/1f530.png?v8.png) Prevent caching of sensitive data](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-prevent-caching-of-sensitive-data)

#### [Rationale](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=rationale-25)
...
#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-23)
...
#### [External resources](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=external-resources-25)
...
###  [![beginner](https://github.githubassets.com/images/icons/emoji/unicode/1f530.png?v8.png) Control Buffer Overflow attacks](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-control-buffer-overflow-attacks)

#### [Rationale](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=rationale-26)
...
#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-24)
...
#### [External resources](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=external-resources-26)

- [SCG WS nginx](https://www.owasp.org/index.php/SCG_WS_nginx)

###  [![beginner](https://github.githubassets.com/images/icons/emoji/unicode/1f530.png?v8.png) Mitigating Slow HTTP DoS attacks (Closing Slow Connections)](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=beginner-mitigating-slow-http-dos-attacks-closing-slow-connections)

#### [Rationale](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=rationale-27)
...
#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-25)
...
#### [External resources](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=external-resources-27)
...
## [反向代理](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e5%8f%8d%e5%90%91%e4%bb%a3%e7%90%86)

### [使用与后端协议兼容的 pass 指令](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e4%bd%bf%e7%94%a8%e4%b8%8e%e5%90%8e%e7%ab%af%e5%8d%8f%e8%ae%ae%e5%85%bc%e5%ae%b9%e7%9a%84-pass-%e6%8c%87%e4%bb%a4)
...
### [小心 `proxy_pass` 指令中的斜杠](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e5%b0%8f%e5%bf%83-proxy_pass-%e6%8c%87%e4%bb%a4%e4%b8%ad%e7%9a%84%e6%96%9c%e6%9d%a0)
...
#### [仅使用 `$host` 变量设置和传递 Host 头](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e4%bb%85%e4%bd%bf%e7%94%a8-host-%e5%8f%98%e9%87%8f%e8%ae%be%e7%bd%ae%e5%92%8c%e4%bc%a0%e9%80%92-host-%e5%a4%b4)
...
### [正确设置 `X-Forwarded-For` 头的值](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e6%ad%a3%e7%a1%ae%e8%ae%be%e7%bd%ae-x-forwarded-for-%e5%a4%b4%e7%9a%84%e5%80%bc)

#### [Rationale](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=rationale-28)
...
#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-26)
...
#### [External resources](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=external-resources-28)
...
### [不要在反向代理后面使用带有 `$scheme` 的 `X-Forwarded-Proto`](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e4%b8%8d%e8%a6%81%e5%9c%a8%e5%8f%8d%e5%90%91%e4%bb%a3%e7%90%86%e5%90%8e%e9%9d%a2%e4%bd%bf%e7%94%a8%e5%b8%a6%e6%9c%89-scheme-%e7%9a%84-x-forwarded-proto)

> 反向代理可以设置 `X-Forwarded-Proto`，以告知应用程序它是HTTPS还是HTTP甚至是无效名称。schema 变量仅在需要的时候才会被评估（仅用于当前请求）。
> 
> 如果设置了 $schema 变量且沿途遇上多个代理，则会导致变形。例如：如果客户端转到[https://example.com，则代理将方案值存储为HTTPS。](https://example.xn--com,https-jp6n81dk2gesbs1kr45brjcbs0e4vj0h0d./) 如果代理与下一级代理之间的通信是通过HTTP进行的，则后端会将方案视为HTTP。
...
#### [始终将 Host，X-Real-IP 和 X-Forwarded 标头传递给后端](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e5%a7%8b%e7%bb%88%e5%b0%86-host%ef%bc%8cx-real-ip-%e5%92%8c-x-forwarded-%e6%a0%87%e5%a4%b4%e4%bc%a0%e9%80%92%e7%bb%99%e5%90%8e%e7%ab%af)

#### [Rationale](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=rationale-29)
...
#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-27)
...
### [prefix 使用不带 `X-` 前缀的自定义头](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=prefix-%e4%bd%bf%e7%94%a8%e4%b8%8d%e5%b8%a6-x-%e5%89%8d%e7%bc%80%e7%9a%84%e8%87%aa%e5%ae%9a%e4%b9%89%e5%a4%b4)

#### [Rationale](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=rationale-30)
...
#### [Example](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=example-28)
...
#### [External resources](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=external-resources-29)
...
## [负载均衡](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e8%b4%9f%e8%bd%bd%e5%9d%87%e8%a1%a1)

负载平衡是一种有用的机制，可将传入的流量分布在几个有能力的服务器之间。

### [健康检查](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e5%81%a5%e5%ba%b7%e6%a3%80%e6%9f%a5)
...
### [down 参数](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=down-%e5%8f%82%e6%95%b0)
...
#### [示例](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e7%a4%ba%e4%be%8b)
...
## [安全](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e5%ae%89%e5%85%a8)

### [防盗链](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e9%98%b2%e7%9b%97%e9%93%be)
...
## [参考资料](https://dunwu.github.io/nginx-tutorial/#/nginx-configuration?id=%e5%8f%82%e8%80%83%e8%b5%84%e6%96%99)
