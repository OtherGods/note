...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202403192247629.png)
...
> 1. select 最大的缺陷就是单个进程所打开的 FD 是有一定限制的，它由 FD_SETSIZE 设置，默认值是 1024。（一般来说这个数目和系统内存关系很大，具体数目可以 cat /proc/sys/fs/file-max 查看。32 位机默认是 1024 个。64 位机默认是 2048）
...
LT（level trigger）和 ET（edge trigger）。LT 模式是默认模式，两者区别如下：
...
参考：
1. [网络通信 --> IO 多路复用之 select、poll、epoll 详解](https://www.cnblogs.com/jeakeven/p/5435916.html)
2. [nginx 平台初探](http://tengine.taobao.org/book/chapter_02.html#id1)

> 这应该是 Nginx 系列最后一篇文章了，如果你有疑问，欢迎交流，水平有限，错误欢迎指正。

Nginx 相关文章：
1. [Nginx 负载均衡](https://learnku.com/articles/36737)
2. [Nginx 添加 lua 模块](https://learnku.com/articles/36567)
3. [Nginx 配置常用参数，看这一篇就够了](https://learnku.com/articles/36768)
4. [Nginx 代理缓存](https://learnku.com/articles/36857)
5. [Nginx 内嵌变量](https://learnku.com/articles/36986)
6. [利用 consul+nginx-upsync 实现动态负载](https://learnku.com/articles/37421)

转载自：[https://learnku.com/articles/38414](https://learnku.com/articles/38414)