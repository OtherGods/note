...
HashMap在**扩容的时候**，会将**元素插入链表头部，即头插法**。如下图，原来是A->B->C，扩容后会变成C->B->A”

如下图所示：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507092323254.png)
...
假如说此时有两个线程进行扩容，**两个线程都会创建新数组newTable**，thread-1执行到`Entry<K,V> next = e.next`;的时候被hang住，如下图所示：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507092325657.png)

此时thread-2开始执行，当thread-2扩容完成后，结果如下：![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507092352650.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507092357455.png)
