...
![thread](D:\Tyora\AssociatedPicturesInTheArticles\Java命令学习系列（二）——Jstack\thread.bmp)
...
> 
> （来自[2.1、JAVA线程dump的分析 --- jstack pid](2、相关技术/1、Java基础/Java命令系列/2.1、JAVA线程dump的分析%20---%20jstack%20pid.md)）
...
对照：[jcmd 线程相关参数(替代jstack)](2、相关技术/1、Java基础/Java命令系列/0、jcmd命令.md#jcmd%20线程相关参数(替代jstack))

### 语法

![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202508052339283.png)

- jstack可以查看或导出 Java 应用程序中线程堆栈信息。
- `-l` 长列表. 打印关于锁的附加信息,例如属于java.util.concurrent 的 ownable synchronizers列表.
- `-F` 当`jstack [-l] pid`没有相应的时候强制打印栈信息【没啥用】
...
![thread_meitu_1](D:\Tyora\AssociatedPicturesInTheArticles\Java命令学习系列（二）——Jstack\QQ20160118-0.png)
...
转载自：https://www.hollischuang.com/archives/110
