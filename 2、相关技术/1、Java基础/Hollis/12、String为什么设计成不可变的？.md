...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507291032363.png)
...
不可变性保证了字符串的值不会改变。因此，`hashCode()`方法在String类中被重写，以方便缓存，这样在第一次`hashCode()`调用期间计算和缓存散列，并从那时起返回相同的值。
