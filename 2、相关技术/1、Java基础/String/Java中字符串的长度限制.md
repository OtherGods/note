关于String有没有长度限制的问题，我之前单独写过一篇文章[我说我精通字符串，面试官竟然问我Java中的String有没有长度限制！？](https://juejin.cn/post/6844903912630140942)分析过，最近我又抽空回顾了一下这个问题，发现又有了一些新的认识。于是准备重新整理下这个内容。

这次在之前那篇文章的基础上除了增加了一些验证过程外，还有些错误内容的修正。我这次在分析过程中会尝试对Jdk的编译过程进行debug，并且会参考一些JVM规范等全方面的介绍下这个知识点。

因为这个问题涉及到Java的编译原理相关的知识，所以通过视频的方式讲解会更加容易理解一些，视频我上传到了B站：[www.bilibili.com/video/BV1uK…](https://link.juejin.cn?target=https%3A%2F%2Fwww.bilibili.com%2Fvideo%2FBV1uK4y1t7H1%2F%E3%80%82)
...
其实，形如`String s = "xxx";`定义String的时候，xxx被我们称之为字面量，这种字面量在编译之后会以常量的形式进入到[Class常量池](https://link.juejin.cn?target=https%3A%2F%2Fwww.hollischuang.com%2Farchives%2F2855)。
...
作者：HollisChuang
链接：https://juejin.cn/post/6844904163545989134
来源：稀土掘金
