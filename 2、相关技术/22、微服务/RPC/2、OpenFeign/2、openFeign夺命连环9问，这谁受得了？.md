...
文章目录如下：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506081720658.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506081721332.png)
...
本篇文章Spring Cloud版本、JDK环境、项目环境均和上一篇Nacos的环境相同：[五十五张图告诉你微服务的灵魂摆渡者Nacos究竟有多强？](2、相关技术/22、微服务/注册中心/Nacos/五十五张图告诉你微服务的灵魂摆渡者Nacos究竟有多强？.md)。

注册中心就不再使用`Eureka`了，直接使用`Nacos`作为注册和配置中心，有不会的可以查看Nacos文章。

本篇文章搭建的项目结构如下图：

![图片](https://mmbiz.qpic.cn/mmbiz_png/19cc2hfD2rCXDTpOZ5roJBuKpxeWlRAcWZ6Osu5vl6prfZ2ebKzd1X1FC6eVHHicLt1ibw0IicdErIz6ucQaKrGhQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/19cc2hfD2rCXDTpOZ5roJBuKpxeWlRAc9X3znQVY1st0H9EuhTwbiavyCb8Y4RPfJlLepQGDznapyoskdRribclw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506081751796.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506081753942.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506081756039.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506081826656.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506081830194.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506081832273.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506081836331.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506081842631.png)
...
GZIP压缩传输的原理如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506081844932.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506081846364.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506081852123.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506081900172.png)
...
#### 4.1、对比Sentinel注解SentinelResource异常处理机制

**@FeignClient**:
- `fallback`: 指定降级处理的类
- `fallbackFactory`: 可以获取异常信息的降级工厂
**@SentinelResource**: （参考 [11、如何自定义限流返回的异常信息？](阿里限流神器Sentinel夺命连环%2017%20问？#11、如何自定义限流返回的异常信息？) [12、如何对异常进行降级处理？](阿里限流神器Sentinel夺命连环%2017%20问？#12、如何对异常进行降级处理？) ）
- `blockHandler` / `blockHandlerClass`: 处理流量控制或熔断时的拒绝请求
- `fallback` / `fallbackClass` / `defaultFallback`: 处理业务逻辑异常时的降级
- `exceptionsToIgnore`: 忽略特定异常不计入统计
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506081903053.png)

现在手动造个异常，在服务提供的接口中抛出异常，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506081904166.png)

此时重新调用`http://localhost:9006/openfeign/order3`，返回如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506081904174.png)
...
转载自：[openFeign夺命连环9问，这谁受得了？](https://mp.weixin.qq.com/s/YJu2oN-qxtpShrmHlyrByw)
