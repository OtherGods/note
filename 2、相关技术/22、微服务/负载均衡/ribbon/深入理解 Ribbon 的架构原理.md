...
本篇主要内容如下：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091118807.png)
...
之前我详细讲解了何为高可用[B 站崩了，总结下「高可用」和「异地多活」](http://mp.weixin.qq.com/s?__biz=MzAwMjI0ODk0NA==&mid=2451956637&idx=1&sn=faf59d9804f8fc49045cf9916e2a613a&chksm=8d1c1a02ba6b93143bd4f12af37a8650160c5d070cd688b64fa2b4b0271c23dc871c0e1b0280&scene=21#wechat_redirect)

里面没有涉及到负载均衡机制，其实负载均衡也是高可用网络的关键组件。
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091123771.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091125945.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091126704.png)
...
**Nginx**：性能好，可以负载超过 1W。工作在网络的**7层之上**，可以针对http应用做一些分流的策略。Nginx也可作为静态网页和图片服务器。Nginx仅能支持http、https和Email协议。

**LVS**（Linux Virtual Server）：是一个虚拟服务器集群系统，采用 IP 地址均衡技术和内容请求分发技术实现负载均衡。接近硬件设备的网络吞吐和连接负载能力。抗负载能力强、是工作在网络**4层之上**仅作分发之用。自身有完整的双机热备方案，如LVS+Keepalived。软件本身不支持正则表达式处理，不能做动静分离。
...
接下来就是我们的**重头戏**了，来看下 Ribbon 这个 Spring Cloud 中负载均衡组件。

Ribbon 主要有五大功能组件：ServerList、Rule、Ping、ServerListFilter、ServerListUpdater。
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091135676.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091143699.png)

再来看下 Ribbon 源码中关于均衡策略的 UML 类图。
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091144112.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091158314.png)
...
先来一张 Ribbon 初始化的流程图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091523808.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091542594.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091548476.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091555651.png)
...
转载自：[https://mp.weixin.qq.com/s/4-rh20rAlTwMmROWa-IHsw](https://mp.weixin.qq.com/s/4-rh20rAlTwMmROWa-IHsw)
