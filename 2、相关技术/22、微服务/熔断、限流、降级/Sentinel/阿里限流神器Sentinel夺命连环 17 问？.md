...
参考B站视微服务视频资料：
- [微服务保护](2、相关技术/22、微服务/微服务开发框架SpringCloud+RabbitMQ+Docker+Redis+搜索+分布式微服务全技术栈课程/高级篇/学习资料/day01-微服务保护/讲义/微服务保护.md)
- [sentinel规则持久化](2、相关技术/22、微服务/微服务开发框架SpringCloud+RabbitMQ+Docker+Redis+搜索+分布式微服务全技术栈课程/高级篇/学习资料/day01-微服务保护/资料/sentinel规则持久化.md)
- [Jmeter快速入门](2、相关技术/22、微服务/微服务开发框架SpringCloud+RabbitMQ+Docker+Redis+搜索+分布式微服务全技术栈课程/高级篇/学习资料/day01-微服务保护/资料/Jmeter快速入门.md)

## 1、前言

这是《Spring Cloud 进阶》专栏的第五篇文章，这篇文章介绍一下阿里开源的流量防卫兵Sentinel，一款非常优秀的开源项目，经过近10年的双十一的考验，非常成熟的一款产品。往期文章如下：
- [五十五张图告诉你微服务的灵魂摆渡者Nacos究竟有多强？](2、相关技术/22、微服务/注册中心/Nacos/五十五张图告诉你微服务的灵魂摆渡者Nacos究竟有多强？.md)
- [2、openFeign夺命连环9问，这谁受得了？](2、相关技术/22、微服务/RPC/2、OpenFeign/2、openFeign夺命连环9问，这谁受得了？.md)
- [阿里面试这样问：Nacos、Apollo、Config配置中心如何选型？这10个维度告诉你！](2、相关技术/22、微服务/注册中心/Nacos/阿里面试这样问：Nacos、Apollo、Config配置中心如何选型？这10个维度告诉你！.md)
- [阿里面试败北：5种微服务注册中心如何选型？这几个维度告诉你！](2、相关技术/22、微服务/注册中心/Nacos/阿里面试败北：5种微服务注册中心如何选型？这几个维度告诉你！.md)

文章目录如下：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091850873.png)
...
**Sentinel 的主要特性如下图**：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091853124.png)
...
具体区别如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091855053.png)

## 4、sentinel版本如何选择？

由于陈某写的是Spring Cloud 进阶一个系列，使用的聚合项目，因此版本还是保持和之前文章一样，不清楚的可以看这篇：[五十五张图告诉你微服务的灵魂摆渡者Nacos究竟有多强？](2、相关技术/22、微服务/注册中心/Nacos/五十五张图告诉你微服务的灵魂摆渡者Nacos究竟有多强？.md)

这里选择的`spring-cloud-alibaba-dependencies`的版本是`2.2.1.RELEASE`，因此sentinel版本选择`1.7.1`，大家可以根据自己的版本选择对应sentinel的版本，版本对应关系如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091900133.png)

> **注意**：一定要按照官方推荐的版本适配，否则出现意想不到的BUG追悔莫及.........

## 5、Sentinel 控制台如何安装？

sentinel和**nacos**一样，都有一个控制台，但是这里不用自己手动搭建一个微服务，官方已经搭建好了，只需要下载对应得jar包运行即可。下载地址：[https://github.com/alibaba/Sentinel/tags](https://github.com/alibaba/Sentinel/tags)

选择对应得版本下载即可，我这里选择`1.7.1`版本，下载的jar包如下图：

![图片](https://mmbiz.qpic.cn/mmbiz_png/19cc2hfD2rDegdibpfIEibT8H4QLTMvLsr52XyL63ZIIibPPYjXoIgNUagBtW3sicNwMSwrpt0QSdm7ja6vuZmuKqw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091902499.png)

> 默认的用户名和密码：sentinel/sentinel

登录成功之后页面如下：

![图片](https://mmbiz.qpic.cn/mmbiz_png/19cc2hfD2rDegdibpfIEibT8H4QLTMvLsriaAmecE0Hmgia2ic5kJmuUZ56BCfaQZo8FDaZgjvv7tqB1xybARsmk70A/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091910798.png)
...
这里的注册中心依然使用的是nacos，有不会用的请看专栏第一篇Nacos文章：[五十五张图告诉你微服务的灵魂摆渡者Nacos究竟有多强？](2、相关技术/22、微服务/注册中心/Nacos/五十五张图告诉你微服务的灵魂摆渡者Nacos究竟有多强？.md)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091917745.png)
...
- **strategy**：流控模式（判断的根据是资源自身 **(0)** ，还是根据其它关联资源 **(1)**，还是根据链路入口 **(2)** ），默认值根据资源本身。
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091925056.png)

> **注意**：各个元素的取值以及默认值一定要记住，后续配置将会用到。

以上几个元素在sentinel控制台对应规则如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091931805.png)
...
即 [**预热**](微服务、分布式相关术语#1、预热/冷启动) 方式。当系统长期处于低水位的情况下，当流量突然增加时，直接把系统拉升到高水位可能瞬间把系统压垮。通过"预热"，让通过的流量**缓慢增加**，在**一定时间内**逐渐增加到**阈值上限**，给冷系统一个**预热**的时间，避免冷系统被压垮。
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506091948402.png)


这样配置之后有什么效果呢：QPS起初会从(3/3/=1)每秒通过一次请求开始预热直到5秒之后达到每秒通过3次请求。动态效果图如下：
![1.gif](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506092016101.gif)

从上述动画可以清楚的看见：前几秒是频繁流控的，直到5秒，QPS阈值达到了3。

> 具体算法原理请看：[https://github.com/alibaba/Sentinel/wiki/%E9%99%90%E6%B5%81---%E5%86%B7%E5%90%AF%E5%8A%A8](https://github.com/alibaba/Sentinel/wiki/%E9%99%90%E6%B5%81---%E5%86%B7%E5%90%AF%E5%8A%A8)
...
该方式作用如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506092047559.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506092048471.png)

<font color="red">这个配置的意思是：每秒处理一个请求（QPS=1），如果第0秒来了50个请求，则前11个会被处理（超时时间为10，1秒处理1个请求，10秒处理11个请求，第0秒处理第一个请求，第1秒处理第二个请求……第10秒处理第11个请求），后39个会立即被限流。</font>

此时的效果如下：
![1.gif](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506092055853.gif)

从上图可以看到：连续点击刷新请求，虽然设置了QPS阈值为1，但是并没有被限流，而是在等待，因为1秒内请求数量不到10个，所有请求处理完的时间小于设置的超时等待时间10秒。


> 具体算法原理请看：[https://github.com/alibaba/Sentinel/wiki/%E6%B5%81%E9%87%8F%E6%8E%A7%E5%88%B6-%E5%8C%80%E9%80%9F%E6%8E%92%E9%98%9F%E6%A8%A1%E5%BC%8F](https://github.com/alibaba/Sentinel/wiki/%E6%B5%81%E9%87%8F%E6%8E%A7%E5%88%B6-%E5%8C%80%E9%80%9F%E6%8E%92%E9%98%9F%E6%A8%A1%E5%BC%8F)
...
此时的流控规则配置如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506092103374.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506092106794.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506092117679.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506092121735.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506092125130.png)

熔断降级涉及到的几个属性如下表：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506100920183.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506100936953.png)

使用**Jmeter**开启10个线程循环跑，然后在浏览器中访问这个接口，返回结果如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506100936883.png)
...
> 官方文档：[https://github.com/alibaba/Sentinel/wiki/%E7%83%AD%E7%82%B9%E5%8F%82%E6%95%B0%E9%99%90%E6%B5%81](https://github.com/alibaba/Sentinel/wiki/%E7%83%AD%E7%82%B9%E5%8F%82%E6%95%B0%E9%99%90%E6%B5%81)

概念理解了，来看下sentinel控制台如何设置热点参数限流，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506100954894.png)

规则对应得源码在`com.alibaba.csp.sentinel.slots.block.flow.param.ParamFlowRule`这个类中，各种属性含义如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506100955950.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101005057.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101010745.png)

这也正是验证了上述的热点参数限流配置。

**第二个测试**：浏览器输入：http://localhost:9009/sentinel/provider/order/query?p2=1222，连续点击将会看到这个接口并没有被熔断降级，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101011631.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101012230.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101013460.png)
...
sentinel控制台对应如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101018840.png)

阈值类型有五种，分别如下：
- **Load 自适应**（仅对 Linux/Unix-like 机器生效）：系统的 load1 作为启发指标，进行自适应系统保护。当系统 load1 超过设定的启发值，且系统当前的并发线程数超过估算的系统容量时才会触发系统保护（BBR 阶段）。系统容量由系统的 `maxQps * minRt` 估算得出。设定参考值一般是 `CPU cores * 2.5`。
>   **load1**:在 Sentinel 的系统自适应限流中，参数 “系统的 load1” 是指操作系统层面上的 1 分钟平均负载（Load Average 1），即：在过去 1 分钟内，正在使用或等待 CPU 的线程平均数量。
>   
>   这个数值是从 **Linux 操作系统的 `/proc/loadavg` 文件** 或系统调用中获取的，具体对应的是：
>   ![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101044907.png)
>    - `load1`：1分钟平均负载
>    - `load5`：5分钟平均负载
>    - `load15`：15分钟平均负载
>   Sentinel 中使用的是 `load1`，也就是**最近一分钟系统的繁忙程度**。
>   
>   如果你的系统是 **4核CPU**：
>    - `load1 = 4.0` → CPU 使用率满载
>    - `load1 < 4.0` → 系统相对空闲
>    - `load1 > 4.0` → 有线程排队等待 CPU，说明系统压力大
>    Sentinel 就是基于这个逻辑，**当系统的 load1 超过设定阈值时，触发自适应限流**。
- **CPU usage**（1.5.0+ 版本）：当系统 CPU 使用率超过阈值即触发系统保护（取值范围 0.0-1.0），比较灵敏。
- **平均 RT**：*当单台机器上所有入口流量*的平均 RT 达到阈值即触发系统保护，单位是毫秒。
- **并发线程数**：*当单台机器上所有入口流量*的并发线程数达到阈值即触发系统保护。
- **入口 QPS**：*当单台机器上所有入口流量*的 QPS 达到阈值即触发系统保护。

> 官方文档：[https://github.com/alibaba/Sentinel/wiki/%E7%B3%BB%E7%BB%9F%E8%87%AA%E9%80%82%E5%BA%94%E9%99%90%E6%B5%81](https://github.com/alibaba/Sentinel/wiki/%E7%B3%BB%E7%BB%9F%E8%87%AA%E9%80%82%E5%BA%94%E9%99%90%E6%B5%81)

系统规则的配置比较简单，这里以入口QPS为例进行演示，为了演示真实情况，清掉所有的限流规则，添加系统规则，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101049947.png)

这个QPS系统规则一配置，该微服务中的所有接口都将会被这个规则限制，比如访问：http://localhost:9009/sentinel/provider/pay，连续点击，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101050379.png)
...
> 官方文档：[https://github.com/alibaba/Sentinel/wiki/%E6%B3%A8%E8%A7%A3%E6%94%AF%E6%8C%81](https://github.com/alibaba/Sentinel/wiki/%E6%B3%A8%E8%A7%A3%E6%94%AF%E6%8C%81)

使用`@SentinelResource`注解自定义一个限流异常返回信息，先自定义一个资源，指定兜底方法为`handler`，代码如下：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101057168.png)

第二步：写个对应得兜底方法，必须在同一个类中，代码如下：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101058483.png)

第三步：对资源`QueryOrder`新增一个限流规则，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101058903.png)

第四步：写个controller，代码就不晒了，自己写吧，哈哈。。。。

第五步：调用接口，疯狂点击，将会出现兜底方法中定义的返回信息，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101059136.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101100541.png)

**第二步**：在`@SentinelResource`注解中指定blockHandlerClass为上面的类，blockHandler指定兜底方法名，代码如下：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101100196.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101127952.png)

上述接口并没有进行异常降级处理，因此调用该接口直接返回了异常信息，非常不友好，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101127016.png)

我们可以使用`fallback`指定异常降级的兜底方法，此时业务方法改造如下：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101128345.png)

使用`fallbackClass`属性指定单独一个类处理异常降级，降低了代码的耦合度，`fallback`属性指定了降级兜底的方法，代码如下：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101128906.png)

此时再次访问接口，虽然有异常，但是返回的确实降级兜底方法中的返回信息，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101129430.png)

到了这里基本满足了异常降级的处理需求，但是仍然有个疑问：**能否只用一个方法处理全部的异常？**

答案是：**能**，**必须能**，此时就要用到`defaultFallback`这个属性了，指定默认的降级兜底方法，此时的业务方法变成如下代码：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101129986.png)

`defaultFallback`属性指定了默认的降级兜底方法，这个方法代码如下：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101131344.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101132979.png)

此时不配置任何规则，直接访问接口，可以看到这里直接进入了异常降级处理(代码抛出的不是限流异常BlockException)，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101138433.png)

我们对`createOrder`这个资源配置降级规则：60秒内如果出现2个以上的异常直接限流，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101138738.png)

此时我们再次访问这个接口，可以看到前两次直接进入了`fallback`指定的方法中（并未达到限流的异常数阈值），两次之后就被限流了，进入了`blockHandler`方法中，效果如下图：
![1.gif](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101139307.gif)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101141020.png)

该规则对应得源码为`com.alibaba.csp.sentinel.slots.block.authority.AuthorityRule`，几个属性如下：
- `resource`：资源名，即限流规则的作用对象。
- `limitApp`：对应的黑名单/白名单，不同 origin 用 `,` 分隔，如 `appA,appB`。
- `strategy`：限制模式，`AUTHORITY_WHITE` 为白名单模式，`AUTHORITY_BLACK` 为黑名单模式，默认为白名单模式。
> 官方文档：[https://github.com/alibaba/Sentinel/wiki/%E9%BB%91%E7%99%BD%E5%90%8D%E5%8D%95%E6%8E%A7%E5%88%B6](https://github.com/alibaba/Sentinel/wiki/%E9%BB%91%E7%99%BD%E5%90%8D%E5%8D%95%E6%8E%A7%E5%88%B6)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101157563.png)

然后将`127.0.0.1`设置为黑名单，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101158736.png)

直接访问：http://127.0.0.1:9009/sentinel/rate/order/query?id=1002，结果如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101158947.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101200741.png)

但是官方推荐使用`Push`模式，下面陈某就Push模式介绍一下持久化限流规则。这里使用Nacos作为配置中心。

盗用官方一张架构图，如下：
![1.jpg](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101511022.jpg)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101523385.png)

上述配置中对应的降级（degrade）规则如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101529160.png)

先不纠结JSON数据里面到底是什么，先看效果，全部发布之后，Nacos中总共有了两个配置，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101530140.png)

上图中可以看到我们的两种规则已经在Nacos配置好了，来看一下sentinel中是否已经生效了，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101530591.png)
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101530823.png)
...
> 官方文档：[https://github.com/alibaba/Sentinel/wiki/%E5%9C%A8%E7%94%9F%E4%BA%A7%E7%8E%AF%E5%A2%83%E4%B8%AD%E4%BD%BF%E7%94%A8-Sentinel](https://github.com/alibaba/Sentinel/wiki/%E5%9C%A8%E7%94%9F%E4%BA%A7%E7%8E%AF%E5%A2%83%E4%B8%AD%E4%BD%BF%E7%94%A8-Sentinel)

## 15、限流规则如何推送到Nacos进行持久化？(结合代码看)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101541501.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101542708.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101545404.png)

**需要两边统一，可以自己修改。**

`com.alibaba.csp.sentinel.dashboard.rule.nacos.NacosConfig`这个类中有个方法如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101546298.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101604411.png)

启动成功，在sentinel控制台将会看到有三个实例已经被监控了，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101604453.png)

此时只需要在控制台指定一个服务为token server，其他的为token client，**集群流控->新增token server**，操作如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101605618.png)

选取一个作为服务端，另外两个作为客户端，此时就已经配置好了，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101605097.png)

此时就可以添加集群流控规则了，可以在sentinel控制台直接添加，也可以通过Nacos直接配置，下图是通过Nacos配置的，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101605288.png)

Nacos推送成功后将会在sentinel控制台看到这条流控规则的配置，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101606820.png)
...
> 官方文档：[https://github.com/alibaba/Sentinel/wiki/%E7%BD%91%E5%85%B3%E9%99%90%E6%B5%81](https://github.com/alibaba/Sentinel/wiki/%E7%BD%91%E5%85%B3%E9%99%90%E6%B5%81)

## 18、整合openFeign如何实现熔断降级？

这个在上篇openFeign的文章中有详细介绍：[2、openFeign夺命连环9问，这谁受得了？](2、相关技术/22、微服务/RPC/2、OpenFeign/2、openFeign夺命连环9问，这谁受得了？.md)陈某这里就不再重复介绍了，有不知道的可以看上面这篇文章。
...
转载自：[阿里限流神器Sentinel夺命连环 17 问？](https://mp.weixin.qq.com/s/Q7Xv8cypQFrrOQhbd9BOXw)
