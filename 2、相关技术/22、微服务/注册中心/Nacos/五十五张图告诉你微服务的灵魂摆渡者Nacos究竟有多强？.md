...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101650220.png)

从上图不难看出阿里巴巴的野心，一个Nacos干掉了Spring Cloud的三大组件，分别是`注册中心Eureka`、`服务配置Config`，`服务总线Bus`。

本文目录结构如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101658227.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101715287.png)

不同版本的Alibaba也对应了不同组件的版本，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101715489.png)

> 一定要完全按照文档给出的版本来选择，不然会出现意想不到的BUG，那岂不是鸡鸡....

作者使用的是分模块的聚合项目演示，其中`dependencyManagement`依赖如下，对应着上文提到的版本：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101721791.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101726767.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101726203.png)
...
登录成功的界面如下：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101818279.png)

## 6、服务注册发现

微服务的服务注册和发现相信都用过Eureka，要自己本地构建一个Eureka微服务，但是整合了Alibaba的Nacos则不用那么复杂，直接启动Alibaba提供的Nacos服务即可，这样让程序员把全部精力放在业务上，下面是一个简单的架构图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101819041.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101820088.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101833916.png)

#### 4. 写个演示服务

nacos-provider作为服务提供者注册到nacos中，肯定需要提供个服务来供消费者（nacos-consumer）调用，下面是随便写的一个接口：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101833831.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101833007.png)

OK，在nacos中能够看到服务注册成功了，完成任务..........

### 6.3、nacos-consumer服务消费者创建
...
需要添加`spring-cloud-starter-alibaba-nacos-discovery`这个依赖，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101834047.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101835023.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101837530.png)

因此我们便能使用Ribbon的负载均衡来调用服务，步骤如下：
- 创建RestTemplate，使用`@LoadBalanced`注解标注开启负载均衡，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101837289.png)
- 直接使用注册到nacos的中的服务名作为访问地址调用服务，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101838495.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101839863.png)

#### 5. 启动项目

启动成功之后将会在nacos中的服务列表中查看到两个服务，分别是nacos-provider、nacos-consumer，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101839875.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101841031.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101847676.png)

Nacos配置列表在哪里能看到呢？在管理平台->配置管理->配置列表这一栏，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101851506.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101910706.png)

以上就是添加的`config.version`的配置，发布之后查看列表如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101910364.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101912324.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101914260.png)

此时我们再不重启项目的情况下访问：http://localhost:9003/nacos/test/1，结果如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101914175.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101916067.png)

### 7.8、多环境如何隔离配置？（Namespace）
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101919834.png)

当然我们可以根据业务需要创建自己的命名空间，操作如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101921909.png)

陈某创建了三个，分别是dev、test、prod，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101924087.png)

> 注意：上图中的`命名空间ID`是系统自动生成的唯一ID，后续指定不同的Namespace就用这个ID。

创建完成之后，在配置列表上方则可以看见不同的命名空间，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101924186.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101925074.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101926162.png)

### 7.9、不同业务配置如何隔离？(Group)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101932060.png)

此时命名空间`test`中的配置如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101932603.png)
...
至此，已经全部配置完毕，启动项目，浏览器访问http://localhost:9003/nacos/test/1，结果如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101933008.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506101951198.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506102001636.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506102005213.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506102005447.png)

执行该脚本，将会自动创建表，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506102009195.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506102017906.png)

只需要将`application.properties`中的Mysql配置取消注释并且配置好自己的数据源即可，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506102117090.png)

<font color="red">!!!注意：nacos1.2.1默认连mysql5版本，想连接mysql8需要在与bin同级目录创建文件夹 plugins\mysql 将mysql8的驱动放到这个文件夹下。</font>

修改完毕，重新启动Nacos-server。

如何验证是否持久化呢？很简单，只需要创建一个配置，然后在`his_config_info`表中查看下是否存在即可，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506102117594.png)
...
话不多说，偷一张官网的架构图，如下：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506102121764.png)

上图什么意思呢？说实话，这文档写的真不咋的，很多除初学者一看就懵，请看陈某的架构图，如下：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506102122887.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506102125170.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506102126351.png)

#### 10.2.2、修改集群配置

那么如何配置集群呢？在`conf`目录下有一个`cluster.conf.example`文件，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506102127507.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506102129519.png)
...
-- 我在windows10中实验的是用以下命令启动集群模式
./startup.cmd -m cluster
```

启动成功，访问任意一个端口的Nacos服务，在`集群管理->节点列表`中将会看到自己搭建的三个节点，如下图：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506102130146.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506102206988.png)
...
转载自：[五十五张图告诉你微服务的灵魂摆渡者Nacos究竟有多强？](https://mp.weixin.qq.com/s/UHzew6pIl5sRtRfCgBtLMQ)
