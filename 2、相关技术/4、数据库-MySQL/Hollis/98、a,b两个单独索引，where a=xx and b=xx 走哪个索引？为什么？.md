...
首先，**正常情况下，如果没有 a,b 的联合索引的话，这条 SQL 应该会在 a 和 b 这两个索引之间选择其中一个**，选择的时候*由优化器根据区分度、选择性这样进行选择一个效率更高的*。
...
[97、什么是索引合并，原理是什么？](2、相关技术/4、数据库-MySQL/Hollis/97、什么是索引合并，原理是什么？.md)
