...
编码参考：
1. [字符编码笔记：ASCII，Unicode 和 UTF-8](2、相关技术/1、Java基础/编码/字符编码笔记：ASCII，Unicode%20和%20UTF-8.md)
2. [Unicode与JavaScript详解](2、相关技术/1、Java基础/编码/Unicode与JavaScript详解.md)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507190915652.png)

在MySQL官方文档中，介绍了支持的编码方式之后，还有一段醒目的提醒：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507190915540.png)

翻译过来是：**utf8mb3字符集已被弃用**，它在未来的MySQL版本中将会被删除，请**使用utf8mb4代替**。在目前的**8.0版本中，utf8指的就是utf8mb3**，虽然未来可能改成utf8mb4，但是为了避免产生歧义，可以考虑为字符集引用显式指定utf8mb4，而不是utf8。
