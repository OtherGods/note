...
2. **InnoDB 是聚集索引**，MyISAM 是非聚集索引。MyISAM是采用了一种索引和数据分离的存储方式，Innodb的*聚簇索引中索引和数据在一起*。
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507160923935.png)

# 扩展知识

## 索引结构区别

[74、MyISAM 的索引结构是怎么样的，它存在的问题是什么？](2、相关技术/4、数据库-MySQL/Hollis/74、MyISAM%20的索引结构是怎么样的，它存在的问题是什么？.md)
