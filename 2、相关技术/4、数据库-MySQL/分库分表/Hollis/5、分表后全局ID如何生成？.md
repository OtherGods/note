...
类似于号段法：[号段模式](13、分布式ID生成方案都有哪些？#号段模式)
...
![1.jpg](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506201031286.jpg)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202506201040461.png)

每张分表步长为分表数量，在根据ID查是那张表时，按照公式:`ID % 分表数量` 得到的值就是具体的表
...
[15、什么是雪花算法，怎么保证不重复的？](2、相关技术/21、分布式/Hollis/15、什么是雪花算法，怎么保证不重复的？.md)
