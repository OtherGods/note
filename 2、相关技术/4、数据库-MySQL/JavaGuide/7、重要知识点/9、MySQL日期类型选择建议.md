...
下图是 MySQL 日期类型所占的存储空间（官方文档传送门：[https://dev.mysql.com/doc/refman/8.0/en/storage-requirements.htmlopen in new window](https://dev.mysql.com/doc/refman/8.0/en/storage-requirements.html)）：

![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202407201046585.png)
...
> 
> 1970年1月1日00:00:00 UTC 对应中国标准时间为**1970年1月1日08:00:00**。
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202407201104960.png)

每种方式都有各自的优势，根据实际场景选择最合适的才是王道。下面再对这三种方式做一个简单的对比，以供大家实际开发中选择正确的存放时间的数据类型：

| 类型        | 存储空间  | 日期格式                           | 日期范围                                                        | 是否带时区信息 |
| --------- | ----- | ------------------------------ | ----------------------------------------------------------- | ------- |
| DATETIME  | 5-8字节 | YYYY_MM_DD hh:mm:ss[.fraction] | 1000-01-01 00:00:00[.000000] ～ 9999-12-31 23:59:59[.999999] | 否       |
| TIMESTAMP | 4-7字节 | YYYY-MM-DD hh:mm:ss[.fraction] | 1970-01-01 00:00:01[.000000] ～ 2038-01-19 03:14:07[.999999] | 是       |
| 数值类型时间戳   | 4字节   | 全数字如 1578707612                | 1970-01-01 00:00:01 之后的时间                                   | 否       |


转载自：[https://javaguide.cn/database/mysql/some-thoughts-on-database-storage-time.html](https://javaguide.cn/database/mysql/some-thoughts-on-database-storage-time.html)
