...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408111838052.png)
...
你可以通过这个网站在线进行编码和解码：[https://www.haomeili.net/HanZi/ZiFuBianMaZhuanHuan](https://www.haomeili.net/HanZi/ZiFuBianMaZhuanHuan)
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408111844098.png)

这样我们就搞懂了乱码的本质：**编码和解码时用了不同或者不兼容的字符集** 。
![](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408111851763.png)

为了解决这个问题，人们就想：“如果我们能够有一种字符集将世界上所有的字符都纳入其中就好了！”。

然后，**Unicode** 带着这个使命诞生了。

Unicode 字符集中包含了世界上几乎所有已知的字符。不过，Unicode 字符集并没有规定如何存储这些字符（也就是如何使用二进制数据表示这些字符）。<font color = "red">【按照我的理解，也就是说：Unicode字符集中包含了所有字符和十进制数字的映射关系，而不同编码就是将这些数字转换为二进制的不同方式】</font>
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408111856228.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408111857489.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202408111915543.png)
...
## 5、参考
- 字符集和字符编码（Charset & Encoding）：[https://www.cnblogs.com/skynet/archive/2011/05/03/2035105.htmlopen in new window](https://www.cnblogs.com/skynet/archive/2011/05/03/2035105.html)
- 十分钟搞清字符集和字符编码：[http://cenalulu.github.io/linux/character-encoding/open in new window](http://cenalulu.github.io/linux/character-encoding/)
- Unicode-维基百科：[https://zh.wikipedia.org/wiki/Unicodeopen in new window](https://zh.wikipedia.org/wiki/Unicode)
- GB2312-维基百科：[https://zh.wikipedia.org/wiki/GB_2312open in new window](https://zh.wikipedia.org/wiki/GB_2312)
- UTF-8-维基百科：[https://zh.wikipedia.org/wiki/UTF-8open in new window](https://zh.wikipedia.org/wiki/UTF-8)
- GB18030-维基百科: [https://zh.wikipedia.org/wiki/GB_18030open in new window](https://zh.wikipedia.org/wiki/GB_18030)
- MySQL8 文档：[https://dev.mysql.com/doc/refman/8.0/en/charset.htmlopen in new window](https://dev.mysql.com/doc/refman/8.0/en/charset.html)
- MySQL5.7 文档：[https://dev.mysql.com/doc/refman/5.7/en/charset.htmlopen in new window](https://dev.mysql.com/doc/refman/5.7/en/charset.html)
- MySQL Connector/J 文档：[https://dev.mysql.com/doc/connector-j/8.0/en/connector-j-reference-charsets.html](https://dev.mysql.com/doc/connector-j/8.0/en/connector-j-reference-charsets.html)


---

著作权归JavaGuide(javaguide.cn)所有 基于MIT协议 原文链接：[https://javaguide.cn/database/character-set.html](https://javaguide.cn/database/character-set.html)
