...
这里在applicationContext.publishEvent(new CaseStartFinishEvent(caseModel.getCaseItem()));中发送一个事件，并且用try-catch包上，一旦失败了，不影响主流程。
...
[6、分库分表后会带来哪些问题？](2、相关技术/4、数据库-MySQL/分库分表/Hollis/6、分库分表后会带来哪些问题？.md)
[23、在Spring中如何使用Spring Event做事件驱动](2、相关技术/15、常用框架-SSM+SpringSecurity/Hollis/Spring/23、在Spring中如何使用Spring%20Event做事件驱动.md)
[1、如何解决接口幂等的问题？](2、相关技术/21、分布式/Hollis/18、幂等/1、如何解决接口幂等的问题？.md)
