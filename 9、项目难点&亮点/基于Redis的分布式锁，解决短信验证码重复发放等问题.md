...
https://www.aliyun.com/search?spm=5176.21213303.J_6704733920.6.34b853c98er6CO&k=%E7%9F%AD%E4%BF%A1%E9%AA%8C%E8%AF%81%E7%A0%81&scene=market&page=1
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507261838503.png)

对接都很简单，只需要通过HTTP接口调用即可实现短信发送。

## 验证码存储&验证

Redis是一个分布式的缓存，可以**把验证码信息临时放到Redis中**，借助redis的超时自动删除功能，可以实现5分钟内才能进行验证码的校验的功能。
...
- [7、如何用Zookeeper实现分布式锁？](2、相关技术/21、分布式/Hollis/Zookeeper/7、如何用Zookeeper实现分布式锁？.md)
