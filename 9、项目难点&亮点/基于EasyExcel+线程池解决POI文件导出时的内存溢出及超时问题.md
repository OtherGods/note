...
[13、POI导致内存溢出排查](10、线上问题排查/Hollis/13、POI导致内存溢出排查.md)

# 技术选型

Excel的导出很多种方案，包括了`POI`、`EasyExcel`还有Hutool中也有类似的功能。在市面上，用的最多的还是`POI`和`EasyExcel`，而在处理大文件这方面，EasyExcel更加适合一些。
...
[24、为什么不建议直接使用Spring的@Async](2、相关技术/15、常用框架-SSM+SpringSecurity/Hollis/Spring/24、为什么不建议直接使用Spring的@Async.md)
