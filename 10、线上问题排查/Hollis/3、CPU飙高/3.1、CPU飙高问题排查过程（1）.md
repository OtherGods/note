[什么是CPU利用率？怎么算的？](4、操作系统/Hollis/什么是CPU利用率？怎么算的？.md)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202508091800674.png)
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202508091802221.png)
...
但是，基于对TDDL的了解，TDDL每次从数据库中查询sequence序列的时候，默认会取出1000条，缓存在本地，只有**用完之后才会再从数据库获取下一个1000条序列**。
...
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202508091809672.png)

sequence的写操作QPS也有明显下降：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202508091809635.png)

于是我们开始了新的一轮压测，但是发现，CPU的使用率还是很高，压测的QPS还是上不去，于是重新使用Arthas查看线程的情况。
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202508091809298.png)
