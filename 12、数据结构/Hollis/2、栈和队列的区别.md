...
栈：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507102008857.png)

队列：
![image.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507102009061.png)
...
在Java中，常见的栈有Stack，Deque(implemented by LinkedList)，常见的队列有Queue和Deque（implemented by LinkedList）所以我们一般刷题的时候，常常会用下面的写法：
```java
...
![1.png](https://raw.githubusercontent.com/OtherGods/MaterialImage/main/img/202507102038437.png)
...
[2、如何用栈实现一个队列？](11、编程题/Hollis/2、如何用栈实现一个队列？.md)

## 队列实现栈

[1、如何用队列实现一个栈？](11、编程题/Hollis/1、如何用队列实现一个栈？.md)
